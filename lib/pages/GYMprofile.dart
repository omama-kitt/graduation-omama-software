            ...
            style: TextStyle(color: Color.fromARGB(255, 195, 54, 255),fontSize: 36 ,fontWeight: FontWeight.bold,),
              ...
              RatingBar.builder(
                ...
                itemBuilder: (context, _) =>
                    (Icon(Icons.star, color: Color.fromARGB(214, 166, 0, 255))),
                updateOnDrag: true,
              ...
              Card(
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: Color.fromARGB(255, 195, 54, 255), width: 4),
                      ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ListTile(
                                      ...
                                      title: Text(
                                        "Male : Saturday , Monday , Wednesday.\n\nFemales : Sunday ,    Tuesday  ,Thursday. ",
                                        style: TextStyle(
                                          fontSize: 25.0,
                                          fontWeight: FontWeight.bold,
                                          color:
                                    ...
                                    ListTile(
                                      ...
                                      title: Text(
                                        "Stationary bike device in place.",
                                        style: TextStyle(
                                          fontSize: 25.0,
                                          fontWeight: FontWeight.bold,
                                          color:
                                    ...
                                    ListTile(
                                      ...
                                      title: Text(
                                        "Foot, leg and metatarsal strengthening device.",
                                        style: TextStyle(
                                          fontSize: 25.0,
                                          fontWeight: FontWeight.bold,
                                          color:
                                    ...
                                    ListTile(
                                      ...
                                      title: Text(
                                        "Back muscle strengthening device.",
                                        style: TextStyle(
                                          fontSize: 25.0,
                                          fontWeight: FontWeight.bold,
                                          color:
                                    ...
                                    ListTile(
                                      ...
                                      title: Text(
                                        "Upper,lower and rectus abdominoplasty muscle strengthening device.",
                                        style: TextStyle(
                                          fontSize: 25.0,
                                          fontWeight: FontWeight.bold,
                                          color:
